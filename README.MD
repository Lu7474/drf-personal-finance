Ниже — переработанный вариант README.
Структура такая, как ты просил: сначала описание проекта, потом спринты с кратким описанием, затем установка и конфигурация, и только потом подробности по каждому спринту.
Статус спринта убрал, следующий шаг обновил.
